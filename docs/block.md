<a name="MDBlockComponent"></a>

## MDBlockComponent ⇐ <code>MDComponent</code>
{{desc}}
...
* [MDBlockComponent](#MDBlockComponent) ⇐ <code>MDComponent</code>
    * [new MDBlockComponent()](#new_MDBlockComponent_new)
    * [.properties](#MDBlockComponent+properties)
...
### new MDBlockComponent()
{{desc}}

<a name="MDBlockComponent+properties"></a>

### mdBlockComponent.properties
{{desc}}
...
| leadingAvatar | <code>String</code> | {{desc}} |
| leadingImage | <code>String</code> | {{desc}} |
| leadingVideo | <code>String</code> | {{desc}} |
| leadingIcon | <code>String</code> | {{desc}} |
| leadingSupportingText | <code>String</code> | {{desc}} |
| headline | <code>String</code> | {{desc}} |
| supportingText | <code>String</code> | {{desc}} |
| trailingSupportingText | <code>String</code> | {{desc}} |
| trailingIcon | <code>String</code> | {{desc}} |
| trailingVideo | <code>String</code> | {{desc}} |
| trailingImage | <code>String</code> | {{desc}} |
| trailingAvatar | <code>String</code> | {{desc}} |
...
### mdBlockComponent.hasSectionStart
{{desc}}

**Kind**: instance property of [<code>MDBlockComponent</code>](#MDBlockComponent)  
<a name="MDBlockComponent+hasSectionCenter"></a>

### mdBlockComponent.hasSectionCenter
{{desc}}

**Kind**: instance property of [<code>MDBlockComponent</code>](#MDBlockComponent)  
<a name="MDBlockComponent+hasSectionEnd"></a>

### mdBlockComponent.hasSectionEnd
{{desc}}
