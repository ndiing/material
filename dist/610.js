...
(self.webpackChunk_ndiinginc_material = self.webpackChunk_ndiinginc_material || []).push([
    [610],
    {
        610: (e, t, n) => {
                    ...
                    (u = [
                        {
                            ...
                            value: function () {
                                return (0, o.qy)(
                                    ...
                                    function (e) {
                                        return console.log(e.currentTarget.selection);
                                    },
                                    function (e) {
                                        return console.log(e.currentTarget.selection);
                                    },
                                    ...
                                    function () {
                                        return datetimePicker1.toggle({ trigger: button1 });
                                    },
                                    function (e) {
                                        return console.log(e.currentTarget.selection);
                                    },
                                    ...
                                    function () {
                                        return datetimePicker2.toggle({ trigger: button2 });
                                    },
                                );
                                var e, t;
                            },
            ...
            customElements.define("demo-datetime-picker", f);
            const d = document.createElement("demo-datetime-picker");
        },
    },
]);
