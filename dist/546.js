"use strict";(self.webpackChunkwebpack_project=self.webpackChunkwebpack_project||[]).push([[546],{2546(e,l,t){var o=t(420),d=t(9757),a=t(7200);class s extends d.O{north=(0,a._)();east=(0,a._)();south=(0,a._)();west=(0,a._)();render(){return o.qy`
            
            <md-layout>
                <md-layout-item ${(0,a.K)(this.north)} region="north" size="64" collapsedSize="32" docked .expanded="${!1}" open modal .showScrimOnOpen="${!1}" showScrimOnExpanded .closeOnScrimClick="${!1}" collapseOnScrimClick>
                    <div style="padding:16px 24px;">north</div>
                </md-layout-item>
                <md-layout-item ${(0,a.K)(this.east)} region="east" size="256" collapsedSize="32" docked .expanded="${!1}" open modal .showScrimOnOpen="${!1}" showScrimOnExpanded .closeOnScrimClick="${!1}" collapseOnScrimClick>
                    <div style="padding:16px 24px;">east</div>
                </md-layout-item>
                <md-layout-item ${(0,a.K)(this.south)} region="south" size="64" collapsedSize="32" docked .expanded="${!1}" open modal .showScrimOnOpen="${!1}" showScrimOnExpanded .closeOnScrimClick="${!1}" collapseOnScrimClick>
                    <div style="padding:16px 24px;">south</div>
                </md-layout-item>
                <md-layout-item ${(0,a.K)(this.west)} region="west" size="256" collapsedSize="32" docked .expanded="${!1}" open modal .showScrimOnOpen="${!1}" showScrimOnExpanded .closeOnScrimClick="${!1}" collapseOnScrimClick>
