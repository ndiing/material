define(["exports"], function (t) {
    ...
    let c;
    const a = { googleAnalytics: "googleAnalytics", precache: "precache-v2", prefix: "workbox", runtime: "runtime", suffix: "undefined" != typeof registration ? registration.scope : "" },
    ...
    class U {
        constructor(t, e) {
            (this.u = {}), Object.assign(this, e), (this.event = e.event), (this.l = t), (this.p = new m()), (this.R = []), (this.m = [...t.plugins]), (this.v = new Map());
        ...
        async getCacheKey(t, e) {
            ...
            if (!this.u[s]) {
                let n = t;
                for (const t of this.iterateCallbacks("cacheKeyWillBeUsed")) n = q(await t({ mode: e, request: n, event: this.event, params: this.params }));
                this.u[s] = n;
            }
            return this.u[s];
        }
    ...
    class b extends L {
        constructor(t = {}) {
            (t.cacheName = u(t.cacheName)), super(t), (this.C = !1 !== t.fallbackToNetwork), this.plugins.push(b.copyRedirectedCacheableResponsesPlugin);
        }
        async _(t, e) {
    ...
    class C {
        constructor({ cacheName: t, plugins: e = [], fallbackToNetwork: s = !0 } = {}) {
            (this.K = new Map()), (this.T = new Map()), (this.W = new Map()), (this.l = new b({ cacheName: u(t), plugins: [...e, new p({ precacheController: this })], fallbackToNetwork: s })), (this.install = this.install.bind(this)), (this.activate = this.activate.bind(this));
        }
        get strategy() {
            return this.l;
        }
