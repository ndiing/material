...
(self.webpackChunk_ndiinginc_material = self.webpackChunk_ndiinginc_material || []).push([
    [2116],
    {
        2116: (t, e, n) => {
                    ...
                    (u = [
                        {
                            key: "render",
                            value: function () {
                                return (0, o.qy)(r || ((t = ['\n            <div class="md-layout__border">\n                <md-bottom-app-bar\n                    id="bottomAppBar1"\n                    open\n                    .actions="', '"\n                ></md-bottom-app-bar>\n                <md-sheet region="center">\n                    <div class="md-layout">\n                        <md-button\n                            variant="filled-tonal"\n                            label="Toggle Bottom App Bar"\n                            @click="', '"\n                        ></md-button>\n                    </div>\n                </md-sheet>\n            </div>\n        ']), e || (e = t.slice(0)), (r = Object.freeze(Object.defineProperties(t, { raw: { value: Object.freeze(e) } })))), [{ icon: "check_box" }, { icon: "brush" }, { icon: "mic" }, { icon: "image" }], function () {
            ...
            customElements.define("demo-bottom-app-bar-no-fab", p);
            const b = document.createElement("demo-bottom-app-bar-no-fab");
        },
    },
]);
