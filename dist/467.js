"use strict";(self.webpackChunkwebpack_project=self.webpackChunkwebpack_project||[]).push([[467],{2467(m,e,d){var u=d(420),n=d(9757);class t extends n.O{constructor(){super()}render(){return u.qy`
            <form @submit="${m=>m.preventDefault()}">
                    ...
                    <md-grid-column expanded="12" medium="8" compact="4">
                        <md-grid>
                            ...
                            <md-grid-column expanded="4" medium="4" compact="4">
                                ...
                                <md-input-segment value="test" min="1000" max="9999" startValue="2026" placeholder="----" maxLength="4" .clampOnInput="${!1}"></md-input-segment>
                            </md-grid-column>
                            <md-grid-column expanded="4" medium="4" compact="4">
                    ...
                    <md-grid-column expanded="12" medium="8" compact="4">
                        <md-grid>
                            ...
                            <md-grid-column expanded="4" medium="4" compact="4">
                                ...
                                <md-input-segment value="2026" min="1000" max="9999" startValue="2026" placeholder="----" maxLength="4" .clampOnInput="${!1}"></md-input-segment>
                            </md-grid-column>
                            <md-grid-column expanded="4" medium="4" compact="4">
                    ...
                    <md-grid-column expanded="12" medium="8" compact="4">
                        <md-grid>
                            ...
                            <md-grid-column expanded="4" medium="4" compact="4">
                                ...
                                <md-input-segment min="1000" max="9999" startValue="2026" placeholder="----" maxLength="4" .clampOnInput="${!1}"></md-input-segment>
                            </md-grid-column>
                            <md-grid-column expanded="4" medium="4" compact="4">
                                <input type="month">
                            </md-grid-column>
        ...
        `}}customElements.define("demo-input-enum",t);const r=document.createElement("demo-input-enum");d.d(e,["default",0,r])}}]);