"use strict";(self.webpackChunkwebpack_project=self.webpackChunkwebpack_project||[]).push([[775],{8156(e,l,o){var n=o(420),i=o(9757),t=o(7200);class a extends i.O{west=(0,t._)();constructor(){super(),this.items9=[{id:0,leading:[{component:"icon",icon:"image"}],label:"Item 1",selected:!0},{id:1,leading:[{component:"icon",icon:"image"}],label:"Item 2"},{id:2,leading:[{component:"icon",icon:"image"},{component:"badge",label:0}],label:"Item 3"},{id:3,leading:[{component:"icon",icon:"image"},{component:"badge",label:3}],label:"Item 4"}],this.handleToggleCollapse=this.handleToggleCollapse.bind(this)}render(){return n.qy`
        ...
        `}handleClickWest(){this.west.value.toggle()}handleToggleCollapse(){this.west.value.toggleCollapse()}}customElements.define("demo-navigation-rail",a);const d=document.createElement("demo-navigation-rail");o.d(l,["default",0,d])}}]);