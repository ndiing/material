...
/**
 * MDDialogHeaderComponent represents the header component for a dialog.
 *
 * @extends MDCardHeaderComponent
 */
class MDDialogHeaderComponent extends MDCardHeaderComponent {
    /**
...
customElements.define("md-dialog-header", MDDialogHeaderComponent);

export { MDDialogHeaderComponent };
