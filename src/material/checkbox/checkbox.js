...
class MdCheckboxComponent extends LitElement {
    ...
    get checkboxNative(){return this.querySelector('.md-checkbox__native')}
    get checkboxTrack(){return this.querySelector('.md-checkbox__track')}
    get checkboxThumb(){return this.querySelector('.md-checkbox__thumb')}
    ...
    onCheckboxNativeInput(event) {
        ...
        this.dispatchEvent(new CustomEvent('onCheckboxNativeInput',{
            bubbles:true,
            cancelable:true,
            detail:{event}
        }))
