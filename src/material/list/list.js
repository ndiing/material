...
class MdListItemComponent extends LitElement {
  ...
  renderItem(item = {}) {
    return choose(
      ...
      [
        ...
        [
          'md-icon',
          () => html`<md-icon class="md-list__icon">${item.icon}</md-icon>`,
        ],
        [
          'md-checkbox',
          () =>
            html`<md-checkbox
              ...
              .checked="${item.checked ?? this.activated}"
            ></md-checkbox>`,
        ],
        [
          'md-radio-button',
        ...
        [
          'md-supporting-text',
          () =>
            html`<div class="md-list__supporting-text">
              ${item.supportingText}
            </div>`,
        ],
      ],
  ...
  render() {
    return html`
      ${this.leadingItems?.length
        ? html`<div class="md-list__start">
            ${this.leadingItems.map((item) => this.renderItem(item))}
          </div>`
        : nothing}
      ${this.label || this.supportingText
        ? html`
            <div class="md-list__center">
              ${this.label
                ? html`<div class="md-list__label">${this.label}</div>`
                : nothing}
              ${this.supportingText
                ? html`<div class="md-list__supporting-text">
                    ${this.supportingText}
          ...
          `
        : nothing}
      ${this.trailingItems?.length
        ? html`<div class="md-list__end">
