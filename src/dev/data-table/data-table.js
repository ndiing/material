...
const columns = [
  ...
  const rows = [
    ...
    { symbol: 'AMZN', company: 'Amazon.com Inc.', price: 3425.10, change: 0.89, volume: 4567000, marketCap: 1700e9 },
...
class DevDataTable extends MDComponent {
    render() {
        return html`
            <div class="md-layout-border" style="background-color:var(--md-sys-color-surface-container-lowest);margin:24px;width:1280px;height:720px;">
