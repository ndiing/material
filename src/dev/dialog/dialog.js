                ...
                <div class="md-layout-border__item md-layout-border__item--center">
                    <div class="md-layout-column">
                        ...
                        <div class="md-layout-column__item md-layout-column__item--expanded2 md-layout-column__item--medium8 md-layout-column__item--compact4">
                            ...
                            <md-dialog id="dialog0" @onCardButtonClick="${() => dialog0.close()}" style="width:280px;" label="Lorem ipsum dolor" actions='[{"component":"spacer"},{"label":"label"},{"label":"label"}]'> 
                                Lorem ipsum dolor sit amet.
                                Beatae commodi eos eligendi est?
                                Illo tempora a rerum ex.
                            </md-dialog>
                        ...
                        <div class="md-layout-column__item md-layout-column__item--expanded2 md-layout-column__item--medium8 md-layout-column__item--compact4">
                            ...
                            <md-dialog id="dialog1" @onCardIconButtonClick="${() => dialog1.close()}" variant="full" label="Lorem ipsum dolor" leadingActions='[{"icon":"close"}]' trailingActions='[{"component":"button","label":"save"}]' > 
                                Lorem ipsum dolor sit amet.
                                Beatae commodi eos eligendi est?
                                Illo tempora a rerum ex.
                            </md-dialog>
