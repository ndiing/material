            ...
            <div class="md-layout-border">
                <div class="md-layout-border__item md-layout-border__item--center">
                    <div class="md-layout-column">
                        ...
                        <div class="md-layout-column__item md-layout-column__item--expanded12 md-layout-column__item--medium8 md-layout-column__item--compact4">
                            <md-pagination .options="${options0}" total="1000000" limit="50" page="1" .firstPage="${false}" .lastPage="${false}" .label="${null}" .text="${null}" @onPaginationInput="${console.log}" @onPaginationLimitChange="${console.log}" @onPaginationFirstClick="${console.log}" @onPaginationPrevClick="${console.log}" @onPaginationNextClick="${console.log}" @onPaginationLastClick="${console.log}"></md-pagination>
                        </div>
                    </div>
                </div>
            </div>
