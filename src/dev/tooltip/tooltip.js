                ...
                <div class="md-layout-border__item md-layout-border__item--center">
                    <div class="md-layout-column">
                        <div class="md-layout-column__item md-layout-column__item--expanded12 md-layout-column__item--medium8 md-layout-column__item--compact4">
                            ...
                            <md-button variant="tonal" label="Plain tooltip" @pointerenter="${(event) => tooltip0.show(event.currentTarget)}" @pointerleave="${(event) => tooltip0.close(event.currentTarget)}"></md-button>
                        </div>
                        <div class="md-layout-column__item md-layout-column__item--expanded12 md-layout-column__item--medium8 md-layout-column__item--compact4">
                            ...
                            <md-button variant="tonal" label="Plain tooltip" @pointerenter="${(event) => tooltip1.show(event.currentTarget)}" @pointerleave="${(event) => tooltip1.close(event.currentTarget)}"></md-button>
                        </div>
                        <div class="md-layout-column__item md-layout-column__item--expanded12 md-layout-column__item--medium8 md-layout-column__item--compact4">
                            ...
                            <md-button variant="tonal" label="Subhead, supporting text, and two buttons" @pointerenter="${(event) => tooltip2.show(event.currentTarget)}"></md-button>
                        </div>
                        <div class="md-layout-column__item md-layout-column__item--expanded12 md-layout-column__item--medium8 md-layout-column__item--compact4">
                            ...
                            <md-button variant="tonal" label="Subhead, supporting text, and one button" @pointerenter="${(event) => tooltip3.show(event.currentTarget)}"></md-button>
                        </div>
                        <div class="md-layout-column__item md-layout-column__item--expanded12 md-layout-column__item--medium8 md-layout-column__item--compact4">
                            ...
                            <md-button variant="tonal" label="Subhead and supporting text" @pointerenter="${(event) => tooltip4.show(event.currentTarget)}" @pointerleave="${(event) => tooltip4.close(event.currentTarget)}"></md-button>
                        </div>
                        <div class="md-layout-column__item md-layout-column__item--expanded12 md-layout-column__item--medium8 md-layout-column__item--compact4">
                            ...
                            <md-button variant="tonal" label="Supporting text and one button" @pointerenter="${(event) => tooltip5.show(event.currentTarget)}"></md-button>
                        </div>
                        <div class="md-layout-column__item md-layout-column__item--expanded12 md-layout-column__item--medium8 md-layout-column__item--compact4">
                            ...
                            <md-button variant="tonal" label="Button text and two buttons" @pointerenter="${(event) => tooltip6.show(event.currentTarget)}"></md-button>
                        </div>
                    </div>
                </div>
            </div>
