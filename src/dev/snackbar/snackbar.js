                ...
                <div class="md-layout-border__item md-layout-border__item--center">
                    <div class="md-layout-column">
                        ...
                        <div class="md-layout-column__item md-layout-column__item--expanded2 md-layout-column__item--medium8 md-layout-column__item--compact4">
                            ...
                            <md-snackbar id="snackbar1" actions='[{"label":"label"}]' @onSnackbarShow="${console.log}" @onSnackbarClose="${console.log}" @onCardButtonClick="${() => snackbar1.close()}">Lorem, ipsum dolor.</md-snackbar>
                        ...
                        <div class="md-layout-column__item md-layout-column__item--expanded2 md-layout-column__item--medium8 md-layout-column__item--compact4">
                            ...
                            <md-snackbar id="snackbar3" actions='[{"label":"label"}]' @onSnackbarShow="${console.log}" @onSnackbarClose="${console.log}" @onCardButtonClick="${() => snackbar3.close()}"> Lorem, ipsum dolor. Natus, praesentium provident? </md-snackbar>
                        ...
                        <div class="md-layout-column__item md-layout-column__item--expanded2 md-layout-column__item--medium8 md-layout-column__item--compact4">
                            ...
                            <md-snackbar id="snackbar4" actions='[{"label":"Lorem, ipsum"}]' @onSnackbarShow="${console.log}" @onSnackbarClose="${console.log}" @onCardButtonClick="${() => snackbar4.close()}"> Lorem, ipsum dolor. Natus, praesentium provident? </md-snackbar>
