...
class MoveableComponent extends MDComponent{
    render(){
        // prettier-ignore
        return html`
            <!-- <div class="md-layout"> -->
...
customElements.define('moveable-component',MoveableComponent)

export default document.createElement('moveable-component')