...
class DevBlock extends MDComponent {
    renderCenter() {
        return html`
            ...
            <md-layout variant="column">
                <md-layout-item expanded="4" medium="8" compact="4">
                    <md-button variant="tonal" label="side sheet 0" @click="${() => sideSheet.toggle()}"></md-button>
                </md-layout-item>
                <md-layout-item expanded="4" medium="8" compact="4">
                    <md-button variant="tonal" label="side sheet 1" @click="${() => sideSheet1.toggle(true)}"></md-button>
                </md-layout-item>
            </md-layout>

            <md-layout variant="column">
                <md-layout-item expanded="4" medium="8" compact="4">
                    <md-button variant="tonal" label="bottom app bar 0" @click="${() => bottomAppBar0.toggle()}"></md-button>
                </md-layout-item>
                <md-layout-item expanded="4" medium="8" compact="4">
                    <md-button variant="tonal" label="bottom app bar 1" @click="${() => bottomAppBar1.toggle()}"></md-button>
                </md-layout-item>
            </md-layout>
            ...
            <md-layout variant="column">
                <md-layout-item expanded="4" medium="8" compact="4">
                    <md-button variant="tonal" label="top app bar 0" @click="${() => topAppBar0.toggle()}"></md-button>
                </md-layout-item>
                <md-layout-item expanded="4" medium="8" compact="4">
                    <md-button variant="tonal" label="top app bar 1" @click="${() => topAppBar1.toggle()}"></md-button>
                </md-layout-item>
                <md-layout-item expanded="4" medium="8" compact="4">
                    <md-button variant="tonal" label="top app bar 2" @click="${() => topAppBar2.toggle()}"></md-button>
                </md-layout-item>
                <md-layout-item expanded="4" medium="8" compact="4">
                    <md-button variant="tonal" label="top app bar 3" @click="${() => topAppBar3.toggle()}"></md-button>
                </md-layout-item>
            </md-layout>

            <md-layout variant="column">
                <md-layout-item expanded="4" medium="8" compact="4">
                    <md-pane id="dialog0" class="md-pane--dialog" style="width:280px;" headline="headline" actions='[{"component":"spacer"},{"label":"label"}]'> Lorem ipsum dolor sit. Quia ad in delectus! Quisquam doloribus id hic. </md-pane>
                    <md-button variant="tonal" label="dialog0" @click="${() => dialog0.toggle(true)}"></md-button>
                </md-layout-item>
                <md-layout-item expanded="4" medium="8" compact="4">
                    <md-pane id="dialog1" class="md-pane--dialog" style="width:280px;" leadingActions='[{"icon":"arrow_back"}]' headline="headline" actions='[{"component":"spacer"},{"label":"label"}]'> Lorem ipsum dolor sit. Quia ad in delectus! Quisquam doloribus id hic. </md-pane>
        ...
        return html`
            <md-layout variant="border">
                ...
                <md-layout-item region="center">
                    <md-layout variant="border">
                        <md-pane id="topAppBar0" class="md-pane--top-app-bar md-pane--center-aligned" headline="Center-aligned" leadingActions='[{"icon":"arrow_back"}]' trailingActions='[{"icon":"close"}]'></md-pane>

                        <md-pane id="bottomAppBar0" class="md-pane--bottom-app-bar" leadingActions='[{"icon":"image"},{"icon":"image"},{"icon":"image"},{"icon":"image"}]' trailingActions='[{"component":"fab","icon":"add","variant":"unelevated"}]'></md-pane>
                        ...
                        <md-layout-item region="center">
                            <md-layout variant="border">
                                <md-pane id="topAppBar1" class="md-pane--top-app-bar md-pane--small" headline="Small" leadingActions='[{"icon":"arrow_back"}]' trailingActions='[{"icon":"close"}]'></md-pane>
