...
MDRouter.register([
    {
        path: '', component: MainComponent, children: [
            ...
            { path: "badge", title: "badge", component: BadgeComponent },
            { path: "bottom-app-bar", title: "bottom-app-bar", component: BottomAppBarComponent },
            { path: "bottom-sheet", title: "bottom-sheet", component: BottomSheetComponent },
            { path: "button", title: "button", component: ButtonComponent },
            { path: "card", title: "card", component: CardComponent },
            { path: "carousel", title: "carousel", component: CarouselComponent },
            { path: "checkbox", title: "checkbox", component: CheckboxComponent },
            { path: "chip", title: "chip", component: ChipComponent },
            { path: "date-picker", title: "date-picker", component: DatePickerComponent },
            { path: "dialog", title: "dialog", component: DialogComponent },
            { path: "divider", title: "divider", component: DividerComponent },
            { path: "emoji", title: "emoji", component: EmojiComponent },
            { path: "fab", title: "fab", component: FabComponent },
            { path: "icon", title: "icon", component: IconComponent },
            { path: "icon-button", title: "icon-button", component: IconButtonComponent },
            ...
            { path: "navigation-bar", title: "navigation-bar", component: NavigationBarComponent },
            { path: "navigation-drawer", title: "navigation-drawer", component: NavigationDrawerComponent },
            { path: "navigation-rail", title: "navigation-rail", component: NavigationRailComponent },
            { path: "progress-indicator", title: "progress-indicator", component: ProgressIndicatorComponent },
            { path: "radio-button", title: "radio-button", component: RadioButtonComponent },
            { path: "search", title: "search", component: SearchComponent },
            { path: "segmented-button", title: "segmented-button", component: SegmentedButtonComponent },
            { path: "sheet", title: "sheet", component: SheetComponent },
            { path: "side-sheet", title: "side-sheet", component: SideSheetComponent },
            { path: "slider", title: "slider", component: SliderComponent },
            { path: "snackbar", title: "snackbar", component: SnackbarComponent },
            { path: "switch", title: "switch", component: SwitchComponent },
            { path: "tab", title: "tab", component: TabComponent },
            { path: "text-field", title: "text-field", component: TextFieldComponent },
            { path: "time-picker", title: "time-picker", component: TimePickerComponent },
            { path: "tooltip", title: "tooltip", component: TooltipComponent },
            { path: "top-app-bar", title: "top-app-bar", component: TopAppBarComponent },
        ]
    },
