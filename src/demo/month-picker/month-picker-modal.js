            ...
            <div class="md-layout">
                <div class="md-layout__grid">
                    <div class="md-layout__column--expanded12 md-layout__column--medium4 md-layout__column--compact4">
                        ...
                        <md-month-picker id="monthPicker" modal @onMonthPickerButtonCancelClick="${() => monthPicker.close()}" @onMonthPickerButtonOkClick="${() => monthPicker.close()}"></md-month-picker>
                    </div>
                    <div class="md-layout__column--expanded12 md-layout__column--medium4 md-layout__column--compact4">
                        ...
                        <md-month-picker id="monthPicker2" value="1990-10" modal @onMonthPickerButtonCancelClick="${() => monthPicker2.close()}" @onMonthPickerButtonOkClick="${() => monthPicker2.close()}"></md-month-picker>
                    </div>
                </div>
            </div>
        `;
