...
class DemoListInteractions extends MdElement {
    constructor() {
        super();
...
customElements.define("demo-list-interactions", DemoListInteractions);
export default document.createElement("demo-list-interactions");
