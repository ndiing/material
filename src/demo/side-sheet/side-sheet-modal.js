    ...
    render() {
        return html`
            <div class="md-layout__border">
                ...
                <md-side-sheet id="sideSheet" .actions="${[{ icon: "image" }]}" label="Label" .buttons="${[{ component: "spacer" }, { label: "Label" }, { label: "Label" }]}" modal @onSideSheetIconButtonClick="${(event) => sideSheet.toggle()}" @onSideSheetButtonClick="${(event) => sideSheet.toggle()}">Body</md-side-sheet>
            </div>
        `;
    }
}
