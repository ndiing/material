            ...
            <div class="md-layout">
                <div class="md-layout__grid">
                    <div class="md-layout__column--expanded6 md-layout__column--medium4 md-layout__column--compact4">
                        <md-list items='[{"avatar":"https://api.dicebear.com/9.x/dylan/svg?seed=Leah","label":"Label","sublabel":"Sublabel Sublabel Sublabel Sublabel Sublabel"},{"avatar":"https://api.dicebear.com/9.x/dylan/svg?seed=Leah","label":"Label","sublabel":"Sublabel"},{"avatar":"https://api.dicebear.com/9.x/dylan/svg?seed=Leah","label":"Label"}]'></md-list>
                    </div>
                    <div class="md-layout__column--expanded6 md-layout__column--medium4 md-layout__column--compact4">
                        <md-list
                            .items="${[
