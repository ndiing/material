            ...
            <div class="md-layout">
                <div class="md-layout__grid">
                    <div class="md-layout__column--expanded12 md-layout__column--medium4 md-layout__column--compact4">
                        ...
                        <md-datetime-picker id="datetimePicker" @onDatetimePickerButtonCancelClick="${() => datetimePicker.close()}" @onDatetimePickerButtonOkClick="${() => datetimePicker.close()}"></md-datetime-picker>
                    </div>
                    <div class="md-layout__column--expanded12 md-layout__column--medium4 md-layout__column--compact4">
                        ...
                        <md-datetime-picker id="datetimePicker2" value="1990-10-17T20:30" @onDatetimePickerButtonCancelClick="${() => datetimePicker2.close()}" @onDatetimePickerButtonOkClick="${() => datetimePicker2.close()}"></md-datetime-picker>
                    </div>
                </div>
            </div>
        `;
