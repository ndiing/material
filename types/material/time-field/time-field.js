...
exports.MdTimeFieldComponent = void 0;
 ...
 */
var MdTimeFieldComponent = /** @class */ (function (_super) {
    __extends(MdTimeFieldComponent, _super);
    /**
     */
    function MdTimeFieldComponent() {
        var _this = _super.call(this) || this;
        _this.type = "time";
        return _this;
    }
    Object.defineProperty(MdTimeFieldComponent.prototype, "trailingActions", {
        /**
         * @readonly
         */
        get: function () {
    ...
    /**
     */
    MdTimeFieldComponent.prototype.connectedCallback = function () {
        _super.prototype.connectedCallback.call(this);
        this.classList.add("md-time-field");
    };
    /**
     */
    MdTimeFieldComponent.prototype.disconnectedCallback = function () {
     ...
     * @async
     */
    MdTimeFieldComponent.prototype.createPicker = function () {
    ...
    /**
     */
    MdTimeFieldComponent.prototype.removePicker = function () {
        if (this.picker) {
     ...
     */
    MdTimeFieldComponent.prototype.showPicker = function (options) {
        if (options === void 0) {
            options = {};
        }
        if (this.picker) {
            ...
            if (this.textFieldNative.value) this.picker.value = (0, util_1.parseTime)(this.textFieldNative.value);
            this.picker.show(options);
        }
    };
    /**
     */
    MdTimeFieldComponent.prototype.closePicker = function () {
        if (this.picker) {
     ...
     * @param {Object} [options]
     */
    MdTimeFieldComponent.prototype.togglePicker = function (options) {
        if (this.picker) {
     ...
     * @param {Object} [event]
     */
    MdTimeFieldComponent.prototype.handleTimeFieldWindowClick = function (event) {
     ...
     * @param {Object} [event]
     */
    MdTimeFieldComponent.prototype.handleTimeFieldWindowScroll = function (event) {
        this.closePicker();
    };
    /**
     * @param {Object} [event]
     */
    MdTimeFieldComponent.prototype.handleTimeFieldPickerButtonCancelClick = function (event) {
        this.closePicker();
    };
    /**
     * @param {Object} [event]
     */
    MdTimeFieldComponent.prototype.handleTimeFieldPickerButtonOkClick = function (event) {
        this.textFieldNative.value = (0, util_1.stringifyTime)(this.picker.value);
        this.updateValue();
        this.closePicker();
    };
    /**
     ...
     * @param {Object} [event]
     */
    MdTimeFieldComponent.prototype.handleTextFieldIconButtonPickerClick = function (event) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
     ...
     * @param {Object} [event]
     */
    MdTimeFieldComponent.prototype.handleTextFieldIconButtonClick = function (event) {
    ...
    return MdTimeFieldComponent;
})(text_field_1.MdTextFieldComponent);
exports.MdTimeFieldComponent = MdTimeFieldComponent;
