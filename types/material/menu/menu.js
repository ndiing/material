...
var MdMenuComponent = /** @class */ (function (_super) {
    ...
    MdMenuComponent.prototype.show = function (options) {
        ...
        this.menuWindow = (0, util_1.closestScrollableElement)(this);
        ...
        (0, popper_1.setPosition)(__assign({ container: this, 
            /* prettier-ignore */
            placements: [
     ...
     * @param {Any} [event]
     */
    MdMenuComponent.prototype.handleMenuWindowScroll = function (event) {
        this.close();
    };
    /**
     * @param {Any} [event]
     */
    MdMenuComponent.prototype.handleMenuWindowClick = function (event) {
     ...
     * @param {Any} [event]
     */
    MdMenuComponent.prototype.handleMenuShown = function (event) {
        this.removeEventListener("animationend", this.handleMenuShown);
        this.emit("onMenuShown", { event: event });
    };
    /**
     * @param {Any} [event]
     */
    MdMenuComponent.prototype.handleMenuClosed = function (event) {
        this.removeEventListener("animationend", this.handleMenuClosed);
        this.emit("onMenuClosed", { event: event });
    };
    /**
