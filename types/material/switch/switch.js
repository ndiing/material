...
exports.MdSwitchComponent = void 0;
 ...
 */
var MdSwitchComponent = /** @class */ (function (_super) {
    __extends(MdSwitchComponent, _super);
    /**
     */
    function MdSwitchComponent() {
        return _super.call(this) || this;
    }
    /**
     */
    MdSwitchComponent.prototype.render = function () {
        var _a;
        return (0, lit_1.html)(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n            <input\n                type=\"checkbox\"\n                .name=\"", "\"\n                .value=\"", "\"\n                .indeterminate=\"", "\"\n                .checked=\"", "\"\n                .defaultValue=\"", "\"\n                .defaultIndeterminate=\"", "\"\n                .defaultChecked=\"", "\"\n                class=\"md-switch__native\"\n                @input=\"", "\"\n                @reset=\"", "\"\n            />\n            <div class=\"md-switch__track\">\n                <div class=\"md-switch__thumb\">", "</div>\n            </div>\n        "], ["\n            <input\n                type=\"checkbox\"\n                .name=\"", "\"\n                .value=\"", "\"\n                .indeterminate=\"", "\"\n                .checked=\"", "\"\n                .defaultValue=\"", "\"\n                .defaultIndeterminate=\"", "\"\n                .defaultChecked=\"", "\"\n                class=\"md-switch__native\"\n                @input=\"", "\"\n                @reset=\"", "\"\n            />\n            <div class=\"md-switch__track\">\n                <div class=\"md-switch__thumb\">", "</div>\n            </div>\n        "])), (0, if_defined_js_1.ifDefined)(this.name), (0, if_defined_js_1.ifDefined)(this.value), (0, if_defined_js_1.ifDefined)(this.indeterminate), (0, if_defined_js_1.ifDefined)(this.checked), (0, if_defined_js_1.ifDefined)(this.defaultValue), (0, if_defined_js_1.ifDefined)(this.defaultIndeterminate), (0, if_defined_js_1.ifDefined)(this.defaultChecked), this.handleSwitchNativeInput, this.handleSwitchNativeReset, ((_a = this.icons) === null || _a === void 0 ? void 0 : _a.length) ? (0, lit_1.html)(templateObject_1 || (templateObject_1 = __makeTemplateObject(["<md-icon class=\"md-switch__icon\">", "</md-icon>"], ["<md-icon class=\"md-switch__icon\">", "</md-icon>"])), this.icons[~~this.checked]) : lit_1.nothing);
    };
    /**
     * @async
     */
    MdSwitchComponent.prototype.connectedCallback = function () {
     ...
     * @async
     */
    MdSwitchComponent.prototype.disconnectedCallback = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
     ...
     * @param {Any} [event]
     */
    MdSwitchComponent.prototype.handleSwitchNativeInput = function (event) {
        ...
        this.emit("onSwitchNativeInput", { event: event });
    };
    /**
     * @param {Any} [event]
     */
    MdSwitchComponent.prototype.handleSwitchNativeReset = function (event) {
        this.value = this.defaultValue;
        this.indeterminate = this.defaultIndeterminate;
        this.checked = this.defaultChecked;
        this.emit("onSwitchNativeReset", { event: event });
    };
    /**
    ...
    return MdSwitchComponent;
}(component_1.MdComponent));
exports.MdSwitchComponent = MdSwitchComponent;
