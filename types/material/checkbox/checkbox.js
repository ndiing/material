...
exports.MdCheckboxComponent = void 0;
 ...
 */
var MdCheckboxComponent = /** @class */ (function (_super) {
    __extends(MdCheckboxComponent, _super);
    /**
     */
     ...
     * @async
     */
    MdCheckboxComponent.prototype.disconnectedCallback = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
     ...
     * @param {Object} [event]
     */
    MdCheckboxComponent.prototype.handleCheckboxNativeInput = function (event) {
        var native = event.currentTarget;
        this.indeterminate = native.indeterminate;
        this.checked = native.checked;
        this.emit("onCheckboxNativeInput", { event: event });
    };
    /**
     * @param {Object} [event]
     */
    MdCheckboxComponent.prototype.handleCheckboxNativeReset = function (event) {
        this.value = this.defaultValue;
        this.indeterminate = this.defaultIndeterminate;
        this.checked = this.defaultChecked;
        this.emit("onCheckboxNativeReset", { event: event });
    };
    /**
    ...
    return MdCheckboxComponent;
}(component_1.MdComponent));
exports.MdCheckboxComponent = MdCheckboxComponent;
