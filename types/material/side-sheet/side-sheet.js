    ...
    MdSideSheetComponent.prototype.render = function () {
        ...
        return (0, lit_1.html)(
            ...
            ((_e = this.body) === null || _e === void 0 ? void 0 : _e.length) || ((_f = this.buttons) === null || _f === void 0 ? void 0 : _f.length)
                ? (0, lit_1.html)(
                      templateObject_14 || (templateObject_14 = __makeTemplateObject([' <div class="md-side-sheet__wrapper">', " ", "</div> "], [' <div class="md-side-sheet__wrapper">', " ", "</div> "])),
                      ((_g = this.body) === null || _g === void 0 ? void 0 : _g.length) ? (0, lit_1.html)(templateObject_11 || (templateObject_11 = __makeTemplateObject(['<div class="md-side-sheet__body">', "</div>"], ['<div class="md-side-sheet__body">', "</div>"])), this.body) : lit_1.nothing,
                      ((_h = this.buttons) === null || _h === void 0 ? void 0 : _h.length)
                          ? (0, lit_1.html)(
                                templateObject_13 || (templateObject_13 = __makeTemplateObject([' <div class="md-side-sheet__footer">', "</div> "], [' <div class="md-side-sheet__footer">', "</div> "])),
                                ((_j = this.buttons) === null || _j === void 0 ? void 0 : _j.length)
                                    ? (0, lit_1.html)(
                                          templateObject_12 || (templateObject_12 = __makeTemplateObject([' <div class="md-side-sheet__buttons">', "</div> "], [' <div class="md-side-sheet__buttons">', "</div> "])),
