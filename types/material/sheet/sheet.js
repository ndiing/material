...
var MdSheetComponent = /** @class */ (function (_super) {
    ...
    MdSheetComponent.prototype.render = function () {
        ...
        return (0, lit_1.html)(templateObject_15 || (templateObject_15 = __makeTemplateObject([" ", " ", " "], [" ", " ", " "])), ((_a = this.icons) === null || _a === void 0 ? void 0 : _a.length) || this.label || this.sublabel || ((_b = this.actions) === null || _b === void 0 ? void 0 : _b.length) ? (0, lit_1.html)(templateObject_10 || (templateObject_10 = __makeTemplateObject([" <div class=\"md-sheet__header\">", " ", " ", "</div> "], [" <div class=\"md-sheet__header\">", " ", " ", "</div> "])), ((_c = this.icons) === null || _c === void 0 ? void 0 : _c.length) ? (0, lit_1.html)(templateObject_5 || (templateObject_5 = __makeTemplateObject([" <div class=\"md-sheet__icons\">", "</div> "], [" <div class=\"md-sheet__icons\">", "</div> "])), this.icons.map(function (icon) { return _this.renderComponent(icon, "icon"); })) : lit_1.nothing, this.label || this.sublabel ? (0, lit_1.html)(templateObject_8 || (templateObject_8 = __makeTemplateObject([" <div class=\"md-sheet__labels\">", " ", "</div> "], [" <div class=\"md-sheet__labels\">", " ", "</div> "])), this.label ? (0, lit_1.html)(templateObject_6 || (templateObject_6 = __makeTemplateObject(["<div class=\"md-sheet__label\">", "</div>"], ["<div class=\"md-sheet__label\">", "</div>"])), this.label) : lit_1.nothing, this.sublabel ? (0, lit_1.html)(templateObject_7 || (templateObject_7 = __makeTemplateObject(["<div class=\"md-sheet__sublabel\">", "</div>"], ["<div class=\"md-sheet__sublabel\">", "</div>"])), this.sublabel) : lit_1.nothing) : lit_1.nothing, ((_d = this.actions) === null || _d === void 0 ? void 0 : _d.length) ? (0, lit_1.html)(templateObject_9 || (templateObject_9 = __makeTemplateObject([" <div class=\"md-sheet__actions\">", "</div> "], [" <div class=\"md-sheet__actions\">", "</div> "])), this.actions.map(function (action) { return _this.renderComponent(action, "icon-button"); })) : lit_1.nothing) : lit_1.nothing, ((_e = this.body) === null || _e === void 0 ? void 0 : _e.length) || ((_f = this.buttons) === null || _f === void 0 ? void 0 : _f.length) ? (0, lit_1.html)(templateObject_14 || (templateObject_14 = __makeTemplateObject([" <div class=\"md-sheet__wrapper\">", " ", "</div> "], [" <div class=\"md-sheet__wrapper\">", " ", "</div> "])), ((_g = this.body) === null || _g === void 0 ? void 0 : _g.length) ? (0, lit_1.html)(templateObject_11 || (templateObject_11 = __makeTemplateObject(["<div class=\"md-sheet__body\">", "</div>"], ["<div class=\"md-sheet__body\">", "</div>"])), this.body) : lit_1.nothing, ((_h = this.buttons) === null || _h === void 0 ? void 0 : _h.length) ? (0, lit_1.html)(templateObject_13 || (templateObject_13 = __makeTemplateObject([" <div class=\"md-sheet__footer\">", "</div> "], [" <div class=\"md-sheet__footer\">", "</div> "])), ((_j = this.buttons) === null || _j === void 0 ? void 0 : _j.length) ? (0, lit_1.html)(templateObject_12 || (templateObject_12 = __makeTemplateObject([" <div class=\"md-sheet__buttons\">", "</div> "], [" <div class=\"md-sheet__buttons\">", "</div> "])), this.buttons.map(function (button) { return _this.renderComponent(button, "button"); })) : lit_1.nothing) : lit_1.nothing) : lit_1.nothing);
    };
    /**
     * @async
     */
    ...
    MdSheetComponent.prototype.close = function () {
        ...
        this.open = false;
        if (this.sheetScrim.open)
            this.sheetScrim.close();
