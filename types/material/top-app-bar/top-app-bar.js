...
var MdTopAppBarComponent = /** @class */ (function (_super) {
    ...
    MdTopAppBarComponent.prototype.render = function () {
        var _this = this;
        var _a, _b;
        return (0, lit_1.html)(templateObject_7 || (templateObject_7 = __makeTemplateObject([" ", " ", " ", " "], [" ", " ", " ", " "])), ((_a = this.leadingActions) === null || _a === void 0 ? void 0 : _a.length) ? (0, lit_1.html)(templateObject_2 || (templateObject_2 = __makeTemplateObject([" <div class=\"md-top-app-bar__actions\">", "</div> "], [" <div class=\"md-top-app-bar__actions\">", "</div> "])), this.leadingActions.map(function (action) { return _this.renderIconButton(action); })) : lit_1.nothing, this.label || this.sublabel ? (0, lit_1.html)(templateObject_5 || (templateObject_5 = __makeTemplateObject([" <div class=\"md-top-app-bar__labels\">", " ", "</div> "], [" <div class=\"md-top-app-bar__labels\">", " ", "</div> "])), this.label ? (0, lit_1.html)(templateObject_3 || (templateObject_3 = __makeTemplateObject(["<div class=\"md-top-app-bar__label\">", "</div>"], ["<div class=\"md-top-app-bar__label\">", "</div>"])), this.label) : lit_1.nothing, this.sublabel ? (0, lit_1.html)(templateObject_4 || (templateObject_4 = __makeTemplateObject(["<div class=\"md-top-app-bar__sublabel\">", "</div>"], ["<div class=\"md-top-app-bar__sublabel\">", "</div>"])), this.sublabel) : lit_1.nothing) : lit_1.nothing, ((_b = this.trailingActions) === null || _b === void 0 ? void 0 : _b.length) ? (0, lit_1.html)(templateObject_6 || (templateObject_6 = __makeTemplateObject([" <div class=\"md-top-app-bar__actions\">", "</div> "], [" <div class=\"md-top-app-bar__actions\">", "</div> "])), this.trailingActions.map(function (action) { return _this.renderIconButton(action); })) : lit_1.nothing);
    };
    /**
     * @async
     */
