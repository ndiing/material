 ...
 */
function setTheme(input, customColors) {
    return __awaiter(this, void 0, void 0, function () {
        var theme, systemDark;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (!(input instanceof HTMLImageElement)) return [3 /*break*/, 2];
                    return [4 /*yield*/, (0, material_color_utilities_1.themeFromImage)(input, customColors)];
                case 1:
                    theme = _a.sent();
                    return [3 /*break*/, 3];
                case 2:
                    theme = (0, material_color_utilities_1.themeFromSourceColor)((0, material_color_utilities_1.argbFromHex)(input), customColors);
                    _a.label = 3;
                case 3:
                    ...
                    (0, material_color_utilities_1.applyTheme)(theme, { target: document.body, dark: systemDark });
                    return [2 /*return*/];
            }
        });
    });
