...
var MdSliderComponent = /** @class */ (function (_super) {
    ...
    MdSliderComponent.prototype.renderSliderWrapper = function (value, index) {
        ...
        return (0, lit_1.html)(
            ...
            { index: index },
            (0, if_defined_js_1.ifDefined)(this.min),
            (0, if_defined_js_1.ifDefined)(this.max),
            (0, if_defined_js_1.ifDefined)(this.step),
            (0, if_defined_js_1.ifDefined)(value),
            (0, if_defined_js_1.ifDefined)(this.defaultValue[index]),
            this.handleSliderNativeInput,
            this.handleSliderNativeReset,
            Array.from({ length: this.indicators }, function (v, k) {
                return (0, lit_1.html)(
    ...
    MdSliderComponent.prototype.render = function () {
        ...
        return (0, lit_1.html)(
            ...
            this.value.map(function (value, index) {
                return _this.renderSliderWrapper(value, index);
            }),
            this.name,
            this.value,
        );
