...
exports.MdWeekFieldComponent = void 0;
 ...
 */
var MdWeekFieldComponent = /** @class */ (function (_super) {
    __extends(MdWeekFieldComponent, _super);
    /**
     */
    function MdWeekFieldComponent() {
        var _this = _super.call(this) || this;
        _this.type = "week";
        return _this;
    }
    Object.defineProperty(MdWeekFieldComponent.prototype, "trailingActions", {
        /**
         * @readonly
         */
        get: function () {
    ...
    /**
     */
    MdWeekFieldComponent.prototype.connectedCallback = function () {
        _super.prototype.connectedCallback.call(this);
        this.classList.add("md-week-field");
    };
    /**
     */
    MdWeekFieldComponent.prototype.disconnectedCallback = function () {
     ...
     * @async
     */
    MdWeekFieldComponent.prototype.createPicker = function () {
    ...
    /**
     */
    MdWeekFieldComponent.prototype.removePicker = function () {
        if (this.picker) {
     ...
     */
    MdWeekFieldComponent.prototype.showPicker = function (options) {
        if (options === void 0) {
            options = {};
        }
        if (this.picker) {
            ...
            if (this.textFieldNative.value) this.picker.value = (0, util_1.parseWeek)(this.textFieldNative.value);
            this.picker.show(options);
        }
    };
    /**
     */
    MdWeekFieldComponent.prototype.closePicker = function () {
        if (this.picker) {
     ...
     * @param {Object} [options]
     */
    MdWeekFieldComponent.prototype.togglePicker = function (options) {
        if (this.picker) {
     ...
     * @param {Object} [event]
     */
    MdWeekFieldComponent.prototype.handleWeekFieldWindowClick = function (event) {
     ...
     * @param {Object} [event]
     */
    MdWeekFieldComponent.prototype.handleWeekFieldWindowScroll = function (event) {
        this.closePicker();
    };
    /**
     * @param {Object} [event]
     */
    MdWeekFieldComponent.prototype.handleWeekFieldPickerButtonCancelClick = function (event) {
        this.closePicker();
    };
    /**
     * @param {Object} [event]
     */
    MdWeekFieldComponent.prototype.handleWeekFieldPickerButtonOkClick = function (event) {
        this.textFieldNative.value = (0, util_1.stringifyWeek)(this.picker.value);
        this.updateValue();
        this.closePicker();
    };
    /**
     ...
     * @param {Object} [event]
     */
    MdWeekFieldComponent.prototype.handleTextFieldIconButtonPickerClick = function (event) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
     ...
     * @param {Object} [event]
     */
    MdWeekFieldComponent.prototype.handleTextFieldIconButtonClick = function (event) {
    ...
    return MdWeekFieldComponent;
})(text_field_1.MdTextFieldComponent);
exports.MdWeekFieldComponent = MdWeekFieldComponent;
