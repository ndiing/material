...
exports.MdMonthFieldComponent = void 0;
 ...
 */
var MdMonthFieldComponent = /** @class */ (function (_super) {
    __extends(MdMonthFieldComponent, _super);
    /**
     */
    function MdMonthFieldComponent() {
        var _this = _super.call(this) || this;
        _this.type = "month";
        return _this;
    }
    Object.defineProperty(MdMonthFieldComponent.prototype, "trailingActions", {
        /**
         * @readonly
         */
        get: function () {
    ...
    /**
     */
    MdMonthFieldComponent.prototype.connectedCallback = function () {
        _super.prototype.connectedCallback.call(this);
        this.classList.add("md-month-field");
    };
    /**
     */
    MdMonthFieldComponent.prototype.disconnectedCallback = function () {
     ...
     * @async
     */
    MdMonthFieldComponent.prototype.createPicker = function () {
    ...
    /**
     */
    MdMonthFieldComponent.prototype.removePicker = function () {
        if (this.picker) {
     ...
     */
    MdMonthFieldComponent.prototype.showPicker = function (options) {
        if (options === void 0) {
            options = {};
        }
        if (this.picker) {
            ...
            if (this.textFieldNative.value) this.picker.value = (0, util_1.parseMonth)(this.textFieldNative.value);
            this.picker.show(options);
        }
    };
    /**
     */
    MdMonthFieldComponent.prototype.closePicker = function () {
        if (this.picker) {
     ...
     * @param {Object} [options]
     */
    MdMonthFieldComponent.prototype.togglePicker = function (options) {
        if (this.picker) {
     ...
     * @param {Object} [event]
     */
    MdMonthFieldComponent.prototype.handleMonthFieldWindowClick = function (event) {
     ...
     * @param {Object} [event]
     */
    MdMonthFieldComponent.prototype.handleMonthFieldWindowScroll = function (event) {
        this.closePicker();
    };
    /**
     * @param {Object} [event]
     */
    MdMonthFieldComponent.prototype.handleMonthFieldPickerButtonCancelClick = function (event) {
        this.closePicker();
    };
    /**
     * @param {Object} [event]
     */
    MdMonthFieldComponent.prototype.handleMonthFieldPickerButtonOkClick = function (event) {
        this.textFieldNative.value = (0, util_1.stringifyMonth)(this.picker.value);
        this.updateValue();
        this.closePicker();
    };
    /**
     ...
     * @param {Object} [event]
     */
    MdMonthFieldComponent.prototype.handleTextFieldIconButtonPickerClick = function (event) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
     ...
     * @param {Object} [event]
     */
    MdMonthFieldComponent.prototype.handleTextFieldIconButtonClick = function (event) {
    ...
    return MdMonthFieldComponent;
})(text_field_1.MdTextFieldComponent);
exports.MdMonthFieldComponent = MdMonthFieldComponent;
