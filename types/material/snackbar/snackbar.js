...
var MdSnackbarComponent = /** @class */ (function (_super) {
    ...
    MdSnackbarComponent.prototype.render = function () {
        ...
        return (0, lit_1.html)(
            ...
            ((_a = this.body) === null || _a === void 0 ? void 0 : _a.length) ? (0, lit_1.html)(templateObject_5 || (templateObject_5 = __makeTemplateObject(['<div class="md-snackbar__body">', "</div>"], ['<div class="md-snackbar__body">', "</div>"])), this.body) : lit_1.nothing,
            ((_b = this.buttons) === null || _b === void 0 ? void 0 : _b.length)
                ? (0, lit_1.html)(
                      templateObject_7 || (templateObject_7 = __makeTemplateObject([' <div class="md-snackbar__footer">', "</div> "], [' <div class="md-snackbar__footer">', "</div> "])),
                      ((_c = this.buttons) === null || _c === void 0 ? void 0 : _c.length)
                          ? (0, lit_1.html)(
                                templateObject_6 || (templateObject_6 = __makeTemplateObject([' <div class="md-snackbar__buttons">', "</div> "], [' <div class="md-snackbar__buttons">', "</div> "])),
